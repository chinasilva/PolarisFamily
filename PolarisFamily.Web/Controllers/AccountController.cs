...
using PolarisFamily.Web.Models.AccountViewModels;
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    int count = await _cartItemRepository.UpdateAnonymousCartItem(sessionID, model.Email);
                ...
                {
                    ModelState.AddModelError(string.Empty, "无效的登陆.");
                    return View(model);
                }
            }
