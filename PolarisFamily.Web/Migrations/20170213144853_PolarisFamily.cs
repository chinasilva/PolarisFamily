...
{
    public partial class PolarisFamily : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThumbImagePath = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "ImageRevolutions",
                columns: table => new
                {
                    ImageRevolutionID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageRevolutions", x => x.ImageRevolutionID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NewsID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    NewFlag = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Receiver = table.Column<string>(maxLength: 200, nullable: false),
                    UserID = table.Column<string>(nullable: true),
                    ZipCode = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipAddress", x => x.AddressID);
                });
            ...
            migrationBuilder.CreateTable(
                name: "VideoRevolutions",
                columns: table => new
                {
                    VideoRevolutionID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    NewsID = table.Column<int>(nullable: true),
                    ProductID = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoRevolutions", x => x.VideoRevolutionID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UntiPrice = table.Column<float>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderDetailID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    OrderID = table.Column<Guid>(nullable: false),
                    PlaceDate = table.Column<DateTime>(nullable: true),
                    ProductID = table.Column<int>(nullable: false),
                    ProductName = table.Column<string>(nullable: true),
                    Quantity = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VideoRelativeUrl = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
